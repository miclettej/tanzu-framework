...
import { AzureRegionalClusterParams } from 'management-cluster/src/app/swagger/models';
import { AzureAccountParamsKeys } from './provider-step/azure-provider-step.component';
import { FormMetaDataService } from 'management-cluster/src/app/shared/service/form-meta-data.service';
