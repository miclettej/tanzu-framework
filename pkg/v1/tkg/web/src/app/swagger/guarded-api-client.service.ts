...
export class GuardedAPIClient extends APIClient {
  ...
  getAWSEndpoint(
    requestHttpOptions?: HttpOptions
  ): Observable<models.AWSAccountParams> {
    return super.getAWSEndpoint(requestHttpOptions)
      .pipe(tap((res: any) => guards.isAWSAccountParams(res) || console.error(`TypeGuard for response 'AWSAccountParams' caught inconsistency.`, res)));
  }
